...
<p class="mb-4">
	Have you ever seen Brazilian Zouk or another couple dance and thought, "That looks amazing... but
...
<p class="mt-4">
	...
	just six weeks. No partner needed. No previous experience required. Just curiosity, a willingness
	to try, and a bit of consistency.
</p>
...
<ul>
	...
	<li>
		<a href="/zouk-o-saturday">Zouk'o'Saturdays included</a> &mdash; 5 social dancing events with drop-in
...
<p>
	This course is our way of bringing people together, inviting new people into our dance scene, and
...
<ul class="mb-4">
	...
	<li>
		<ul>
			...
			<li>
				15 extra <a href="/zouk-o-saturday">Zouk'o'Saturday</a> hours of drop-in classes and social dancing
			</li>
		</ul>
	</li>
	<li>Course price:</li>
	...
	{#if accordionOpen}
		<div class="border-t border-gray-200 p-4">
			...
			<p>
				...
				commonplace for a woman to dance as a leader or a man to dance as a follower. Feel free to
