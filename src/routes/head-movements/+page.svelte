...
<ul class="mb-4">
	...
	<li><b>Location:</b> <a href="https://www.helsinkidancecentral.com/">Helsinki Dance Central</a>, Sörnaisten Rantatie 33 C, 4th Floor</li>
...
<h2 class="md:text-2xl text-xl font-bold mb-4">🤝 Spread the Zouk &dash; Referral Program & Discounts</h2>

<p>Would you like to help us grow the Zouk community? Invite your friends to our <a href="/beginners">Zero to Zouk beginner course</a> and you'll get a 20€ discount for the head movements course.</p>

<ul>
	<li>Ask us for your personal <b>discount code</b> to share</li>
	<li>For each person who signs up using your code, you get:
		<ul>
	...
	<li>The person who signed up for Zero to Zouk beginner course gets:
		<ul>
